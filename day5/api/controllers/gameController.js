...
module.exports.gamesGetAll = function (req, res) {
    ...
    if (isNaN(offset) || isNaN(count)) {
        res.status(400).json({ "message": "QueryString offset or count are not valid number" });
        return;
    }
...
module.exports.gamesGetOne = function (req, res) {
    ...
    if (gameId.length != idLength) {
        res.status(400).json({ "message": "The length of the game's ID should be " + idLength });
        return;
    }
